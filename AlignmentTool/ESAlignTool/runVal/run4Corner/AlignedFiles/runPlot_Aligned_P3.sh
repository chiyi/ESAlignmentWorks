...
cmsStage /store/group/alca_ecalcalib/ESalignment/5_3_6/Run2012D_Validation/AlignmentFile_iter1_p11.root ./

root -l -q -b runPlot.C+ > runPlot.log 2>&1
cmsStage ESmF_4Corner_iter11.root $OutputPATH/ESmF_4Corner_iter11_P3.root
cmsStage ESmR_4Corner_iter11.root $OutputPATH/ESmR_4Corner_iter11_P3.root
cmsStage ESpF_4Corner_iter11.root $OutputPATH/ESpF_4Corner_iter11_P3.root 
cmsStage ESpR_4Corner_iter11.root $OutputPATH/ESpR_4Corner_iter11_P3.root 

rm $MYScriptPATH/runPlot_Aligned_P3.log
rm *
